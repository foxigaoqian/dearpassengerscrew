...
**Project:** Dear Passengers Crew
**Generated:** 2026-08-01 11:32:32
**Category:** Gaming
...
|------|-----|--------------|
| Primary | `#FF9F0A` | `--color-primary` |
| On Primary | `#0A1725` | `--color-on-primary` |
| Secondary | `#45E0D0` | `--color-secondary` |
| Accent/CTA | `#FF6B19` | `--color-accent` |
| Background | `#050B12` | `--color-background` |
| Foreground | `#F7F9FC` | `--color-foreground` |
| Muted | `#0C1C2B` | `--color-muted` |
| Border | `rgba(255,255,255,0.13)` | `--color-border` |
| Destructive | `#DC2626` | `--color-destructive` |
| Ring | `#45E0D0` | `--color-ring` |

**Color Notes:** Cinematic aviation navy with action orange and verified-status cyan. Warm paper sections provide long-form reading contrast.

### Typography

- **Heading Font:** Barlow Condensed
- **Body Font:** Manrope
- **Mood:** cinematic, aviation, energetic, precise, editorial, readable
- **Google Fonts:** [Barlow Condensed + Manrope](https://fonts.googleapis.com/css2?family=Barlow+Condensed:wght@500;600;700;800;900&family=Manrope:wght@400;500;600;700;800&display=swap)
...
.input:focus {
  border-color: #45E0D0;
  outline: none;
  box-shadow: 0 0 0 3px rgba(69,224,208,.22);
}
```
