export const LINK_TARGETS = {
  ...
  "news:two-million-wishlists-top-six": ["Two-million-wishlist report", "Read FLEXUS's latest milestone and Steam Top 6 claim."],
...
export const LINK_GRAPH = {
  ...
  "page:news": ["news:two-million-wishlists-top-six", "news:gamescom-demo-plans", "news:one-point-five-million-wishlists", "page:release-date", "page:demo", "tool:status-tracker"],
  ...
  "authority:steam": ["page:release-date", "page:platforms", "page:system-requirements", "authority:price", "authority:languages", "news:two-million-wishlists-top-six", "page:news"],
  ...
  "news:steam-reveal-2026": ["news:700k-wishlists", "page:release-date", "authority:steam", "authority:developer", "page:news"],
  "news:700k-wishlists": ["news:steam-reveal-2026", "news:one-million-wishlists", "authority:steam", "page:news", "authority:developer"],
